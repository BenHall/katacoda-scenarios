...
echo 'ExecStart=/usr/bin/docker run --name postgres \' >> postgres.service
echo ' --volume /opt/db/postgres:/var/lib/pgsql/data \' >> postgres.service
echo ' kiasaki/alpine-postgres' >> postgres.service
...
ssh core@host01 docker pull kiasaki/alpine-postgres
